...
paru -S xorg-server xorg-xinit xorg-xrandr xorg-xsetroot libxft noto-fonts alacritty mpv libxinerama xorg-fonts-misc picom lxappearance brightnessctl pavucontrol playerctl pamixer flameshot otf-font-awesome polkit-gnome xclip feh xtrlock gnome-themes-extra papirus-icon-theme blueman
